...
1. What `geom` would you use to draw a line chart? A boxplot? A histogram? A scatterplot with points spread out for categorical x-axis? ('jitter plot') +2pts
...
2. What does `show.legend = FALSE` do in the code below? What happens if you remove it? +2pts
