...
outlier.shape = NA - Don't show outliers at all

Used when you're adding jittered points that already show ALL the data
Prevents showing outliers twice (once in boxplot, once as jittered points)
