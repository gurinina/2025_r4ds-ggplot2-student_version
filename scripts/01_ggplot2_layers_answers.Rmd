...
3. What's wrong with the following code? How would you fix it? +2pts
...
4. What does the `stroke` aesthetic do? What shapes does it work with? (Hint: use `?geom_point`) +2pts
