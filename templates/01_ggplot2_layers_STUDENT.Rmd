---
title: "ggplot2 Layers - Student Workbook"
output: 
  html_document:
    toc: true
    toc_float: true
...
- Work through this chapter, running all the example code as you go
- Complete the exercises using Think-Pair-Share (see the guide on the course site)
- Type your solutions in the code chunks marked "Your code here"
